        ...
        <div class="row sidebar-page">
            ...
            <div class="col-md-9 page-content">
               ...
               <? callErrorMessage();?>
                ...
                <!-- Classic Heading -->
                <h4 class="classic-title"><span>Testimony Details</span></h4>
...
<form id="postform" name="postform" method="post" action="controller" enctype="multipart/form-data">
    ...
    <td width="75%" align="left">
      <input type="text" name="name" class="email" title="enter name" value="<?=$folder['name']?>">
    </td>
  </tr>
    <tr>
    <td width="25%" align="left" class="leftTd">Testimony:</td>
    <td width="75%" align="left">
    	<textarea name="testimony" title="enter carousel caption" rows="1" cols="50"><?=$folder['testimony']?></textarea>
    </td>
    </tr>
  <tr>
    <td align="left" width="25%">Testimony Status</td>
    <td align="left">
		<select name="status" class="email" style="width:400px">
...
<input type="checkbox" style="cursor:pointer" name="remember" onClick="" id="check_resize"/>
  ...
  <tr>
    ...
    <input type="hidden" name="action" value="update-testimony" />
